...
import { ThemeProvider } from '@/components/theme-provider'; // Corrigido o caminho de importação
...
export const metadata: Metadata = {
  title: {
    default: 'Aprenda Estrutura de Dados',
          ...
          <AppProvider>
            ...
            <footer className="border-t py-6 bg-muted/40">
              <div className="container mx-auto px-4 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Plataforma educacional interativa para facilitar o
              ...
              <div className="container mx-auto px-4 mt-8 pt-6 border-t text-center text-sm text-muted-foreground">
                &copy; {new Date().getFullYear()} DataStructure Learn |
